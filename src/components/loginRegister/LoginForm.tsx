...
const LoginForm: React.FC<{
  ...
  return (
    <form className={classes.devLogin_form} onSubmit={formSubmitHandler} autoComplete='off' >
      ...
      {emailHasError
        ? (
        <p className={classes.invalid_input}>Not valid email!</p>
          )
        : (
      ...
      {passwordHasError
        ? (
         <p className={classes.invalid_input}>Not valid password!</p>
          )
        : (
        <p className={classes.invalid_input_invisible}>lorem</p>
          )}
